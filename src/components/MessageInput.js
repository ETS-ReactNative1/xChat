/*
 * @Author: @LiLPandemio 
 * @Date: 2021-05-08 18:29:30 
 * @Last Modified by:   @LiLPandemio 
 * @Last Modified time: 2021-05-08 18:29:30 
 */
        ...
        return (
            <Animated.View style={{ marginBottom: this.state.keyboardOffset }}>
                <View style={[styles.textInputParentView, {
                    ...
                    <TouchableOpacity
                        onPress={() => {alert('Enviar mensajes no esta soportado aun :(')}}>
                        <View style={styles.buttonPosition}>
                            <View style={[styles.sendButtonStyle, {
                                backgroundColor: this.props.sendButtonBgColor
                            }]}>
